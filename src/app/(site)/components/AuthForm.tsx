  ...
  return (
    <>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className=" bg-white px-4 py-8 shadow sm:rounded-xl sm:px-10 dark:bg-dusk dark:sm:border-2 dark:border-lightgray">
          <div className="flex justify-center mb-8">
            <img className="w-auto h-7 sm:h-10" src="/images/logo.svg" alt="logo" />
          </div>
